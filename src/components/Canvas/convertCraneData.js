...
export default function convertCraneData(craneInfo, partsData, partsList) {
  ...
  for( let i=0 ; i<parts.length ; i++) {
    ...
    // 각도 입력 bodyParts = 0, mainParts = mainAngle, fixLuffPart = flyFixLuffingAngle
...
//             case 18   : N = ['F9m_nsbs','2m_NM_rs','NM_6m','1m_NM_head']; break;
//             case 24   : N = ['F9m_nsbs','NA_6m','2m_NM_rs','NM_6m','1m_NM_head']; break;
//             case 30   : N = ['F9m_nsbs','NA_6m','NA_6m','2m_NM_rs','NM_6m','1m_NM_head']; break;
//             case 36   : N = ['F9m_nsbs','NA_6m','NA_6m','2m_NM_rs','NM_6m','NM_6m','1m_NM_head']; break;
//             case 42   : N = ['F9m_nsbs','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_6m','1m_NM_head']; break;
//             case 48   : N = ['F9m_nsbs','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_12m','1m_NM_head']; break;
//             case 54   : N = ['F9m_nsbs','NA_6m','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_12m','1m_NM_head']; break;
//             case 60   : N = ['F9m_nsbs','NA_6m','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','1m_NM_head']; break;
//             case 66   : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','1m_NM_head']; break;
//             case 72   : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_12m','NM_12m','1m_NM_head']; break;
//             case 78   : N = ['F9m_nsbs','NA_6m','NA_6m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_12m','NM_12m','1m_NM_head']; break;
//             case 84   : N = ['F9m_nsbs','NA_6m','NA_6m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_head']; break;
//             case 90   : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_head']; break;
//             case 96   : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_h','2.2m_NI_rs','3.8m_NI_head']; break;
//             case 102  : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_h','2.2m_NI_rs','NI_6m','3.8m_NI_head']; break;
//             case 108  : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_h','2.2m_NI_rs','NI_6m','NI_6m','3.8m_NI_head']; break;
//             case 114  : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_h','2.2m_NI_rs','NI_6m','NI_12m','3.8m_NI_head']; break;
//             case 120  : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_h','2.2m_NI_rs','NI_6m','NI_6m','NI_12m','3.8m_NI_head']; break;
//             case 126  : N = ['F9m_nsbs','NA_6m','NA_12m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','NM_12m','1m_NM_h','2.2m_NI_rs','NI_6m','NI_12m','NI_12m','3.8m_NI_head']; break;
//             default : N = ['F9m_nsbs','2m_NM_rs','NM_6m','1m_NM_head']; break;
//           }
//         } break;
//         case 'F' : {
//           switch(craneData.flyFixLuffing) {
//             case 6.5  : F = ['F3.5m_TF_bs','2m_NM_rs','1m_NM_head']; break;
//             case 12.5 : F = ['F3.5m_TF_bs','NA_6m','2m_NM_rs','1m_NM_head']; break;
//             case 18.5 : F = ['F3.5m_TF_bs','NA_6m','2m_NM_rs','NM_6m','1m_NM_head']; break;
//             case 24.5 : F = ['F3.5m_TF_bs','NA_6m','NA_6m','2m_NM_rs','NM_6m','1m_NM_head']; break;
//             case 30.5 : F = ['F3.5m_TF_bs','NA_6m','NA_6m','2m_NM_rs','NM_6m','NM_6m','1m_NM_head']; break;
//             case 36.5 : F = ['F3.5m_TF_bs','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_6m','1m_NM_head']; break;
//             case 42.5 : F = ['F3.5m_TF_bs','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_12m','1m_NM_head']; break;
//             case 48.5 : F = ['F3.5m_TF_bs','NA_6m','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_12m','1m_NM_head']; break;
//             case 54.5 : F = ['F3.5m_TF_bs','NA_6m','NA_6m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','1m_NM_head']; break;
//             case 60.5 : F = ['F3.5m_TF_bs','NA_6m','NA_12m','NA_12m','2m_NM_rs','NM_6m','NM_6m','NM_12m','1m_NM_head']; break;
//             default : F = ['F9m_nsbs','2m_NM_rs','NM_6m','1m_NM_head']; break;
//           }
//         } break;
//         default : { F = []; N = []; K = []; }
//       }
...
//         case 'T7F'            : return ['BODY', `T7_${craneData.mainBoom}`, 'A_2.6','A_0.5', ...F]
//         case 'T7F|NZF'        : return ['BODY', `T7_${craneData.mainBoom}`, 'A_2.6','A_0.5', ...F]
//         case 'T7Y'            : return ['BODY', `T7_${craneData.mainBoom}`, 'Y']
//         case 'T7YVEF|NZF'     : return ['BODY', `T7_${craneData.mainBoom}`, 'A_2.6','VE','A_0.5', ...F, 'Y']
//         case 'T7YVEV2F|NZF'   : return ['BODY', `T7_${craneData.mainBoom}`, 'A_2.6','VE','V2','A_0.5', ...F,'Y']
//         case 'T7YVEV3V2F|NZF' : return ['BODY', `T7_${craneData.mainBoom}`, 'A_2.6','VE','V3','V2','A_0.5', ...F, 'Y']
//         case 'T3'             : return ['BODY', `T3_${craneData.mainBoom}`]
//         case 'T3N'            : return ['BODY', `T3_${craneData.mainBoom}`, 'A_2.2','A_2',...N, 'L' ]
//         case 'T3F|NZF'        : return ['BODY', `T3_${craneData.mainBoom}`, 'A_2.2','A_0.5',...F ]
//         case 'T3Y'            : return ['BODY', `T3_${craneData.mainBoom}`, 'Y' ]
//         case 'T3YVEN'         : return ['BODY', `T3_${craneData.mainBoom}`, 'A_2.2', 'VE', 'A_2', ...N ]
//         case 'T3YV2VEN'       : return ['BODY', `T3_${craneData.mainBoom}`, 'A_2.2', 'V2', 'VE', 'A_2', ...N, 'Y','L' ]
